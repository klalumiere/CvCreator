...
\education{
	\whatEn{PhD in Physics (GPA 3.9/4.3)}
	\whatFr{PhD en physique (Moyenne 3.9/4.3)}
	\whenFr{2010-2015}
	\whenEn{2010-2015}
...
\education{
	\whatEn{M. Sc. in Physics (GPA 3.9/4.3)}
	\whatFr{M. Sc. en Physique (Moyenne 3.9/4.3)}
	\whenFr{2008-2010}
	\whenEn{2008-2010}
	\where{Universit\'e de Sherbrooke, Sherbrooke(Qc), Canada}
	\thesis{
...
\education{
	\whatEn{B. Sc. in Physics (GPA 3.9/4.3)}
	\whatFr{B. Sc. en Physique (Moyenne 3.9/4.3)}
	\whenFr{2004-2007}
	\whenEn{2004-2007}
	\where{Universit\'e de Sherbrooke, Sherbrooke(Qc), Canada}
}
