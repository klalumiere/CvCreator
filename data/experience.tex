...
\experience{
	...
	\skill{
		\class{research}
		\En{Studied a quantum computer achitecture using circuit quantum electrodynamic.}
...
\experience{
	...
	\skill{
		\class{computerScience}
		\En{Conception and development of a Google Maps type web site for internatinal communication of teledetection data. Used PHP, HTML, Javascript.}
