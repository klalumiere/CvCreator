...
#Job
\talk{Quantization of lumped elements electrical circuits revisited, APS March Meeting, Baltimore(Maryland), USA, 2016.}

#Doctorat
\talk{Towards a lossless and integrable circulator for quantum superconducting microwave circuits: modelling and optimization, APS March Meeting, San Antonio(Texas), USA, 2015.}
\talk{Circuit QED framework for quantum computing, CONFETI Meeting, Bromont(Qc), Canada, 2014.}
